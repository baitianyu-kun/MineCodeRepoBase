...
# OURS
showRGB(data, data_gt, data, light_mode=True)
# FMR
pose = utils.data_utils.random_pose(0, 0.2)
data_trans = se_math.se3.transform_np(pose, data)
showRGB(data, data_gt, data_trans, light_mode=True)
# PNLK
