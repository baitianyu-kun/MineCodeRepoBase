...
from se_math import se3 as se3
...
class Transformer(nn.Module):
    def __init__(self, emb_dims=512, n_blocks=2, dropout=0.0, ff_dims=1024, n_heads=4):
...
class DCP(nn.Module):
    def __init__(self, emb_dims=512):
        ...
        self.emb_nn = DGCNN(emb_dims=emb_dims)
    ...
    def forward(self, *input):
        ...
        return se3.integrate_trans(rotation_ab, translation_ab)
