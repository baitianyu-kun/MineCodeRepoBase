...
if __name__ == '__main__':
    transformer = Transformer(emb_dims=512, n_blocks=1, dropout=0.0, ff_dims=1024, n_heads=4)
    # batch channel num_pts
    data1 = torch.rand((2, 512, 1024))
    data2 = torch.rand((2, 512, 1024))
    r1, r2 = transformer(data1, data2)
    print(r1.shape)
    print(r2.shape)
