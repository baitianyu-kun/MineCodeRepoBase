...
class PPFLocalGlobalNet(nn.Module):
    ...
    def forward(self, xyz, normals):
        ...
        local_ppf_feat = self.embeddings(local_ppf_feat, self.prepool, self.postpool)
        ...
        if self.use_global:
            ...
            global_ppf_feat = self.embeddings(global_ppf_feat, self.prepool_global, self.postpool_global)
